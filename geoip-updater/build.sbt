...
description:= "A lambda that uses the GeoIPUpdater to download an updated dump of GeoIP data and place it in a specified S3 bucket"
...
//TODO this was copypasta from housekeeper - tidy up what is not needed
